...
int main()
{
	...
	cout << "Digite o Nome do(a) 1º Jogador(a):" << endl;
	cin >> jog1;
	cout << "Digite o Nome do(a) 2º Jogador(a):" << endl;
	cin >> jog2;
	...
	while (!sair)
	{
		...
		// Coloque o código aqui!
		for (int imprimir_moeda=0; imprimir_moeda < moedas; imprimir_moeda++){
			cout << "@" ;
		}
			...
			)
		{
			...
			if (moedas == 0)
			{
				...
				system("pause"); //Espera os Jogadores apertarem qualquer tecla para ir pra proxima Jogada
			}
